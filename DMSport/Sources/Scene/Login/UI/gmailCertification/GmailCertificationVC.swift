    ...
    override func viewDidLoad() {
        ...
        okButton.rx.tap
            .bind {
                ...
                self.provider.rx.request(.postMailAuthentication(PostmailAuthenticationRequest(email: self.emailTextField.text!, authCode: self.checkEmailTextField.text!))).subscribe { response in
                    switch response {
